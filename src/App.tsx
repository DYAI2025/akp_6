...
export default function App() {
  ...
  const filteredProjects = selectedFilter === 'alle' 
    ? projects 
    : projects.filter(p => p.category === selectedFilter || p.tags.includes(selectedFilter));
      ...
      <div className="col-span-12 md:col-span-7 row-span-11 p-5 overflow-y-auto">
        <form className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 border border-[#1a1a1a]/20 flex items-center justify-center text-[10px]">
              {/* TODO: Datenschutztext rechtlich prüfen und ergänzen */}
            </div>
            <span className="text-xs text-[#1a1a1a]/50">
              Ich stimme der Datenverarbeitung zu. {/* TODO: Datenschutztext rechtlich prüfen und ergänzen */}
            </span>
          </div>
          <button 
            type="submit"
